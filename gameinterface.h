...
#define JOYPAD_LEFT  0//Keyboard_Event(1)//(analogRead(A0)>=750)&&(analogRead(A0)<950)
#define JOYPAD_RIGHT 0//Keyboard_Event(2)//(analogRead(A0)>500)&&(analogRead(A0)<750)
#define JOYPAD_DOWN 0//(analogRead(A3)>=750)&&(analogRead(A3)<950)
#define JOYPAD_UP  0//(analogRead(A3)>500)&&(analogRead(A3)<750)
#define JOYPAD_FIRE 0//Keyboard_Event(3)//check_touch()//(digitalRead(1)==0)
